    ...
    const handleSubmit = () => {
        ...
        PostCampForm(data.id, formData)
            .then(res => {
                ...
                history.push('/admin/beatbox_camp_documents');
            }).catch(err => {
                setSubmitting(false);
            })
    }
    ...
    return (
        <div className="pb-4">
            ...
            <div className="d-flex px-1 justify-content-center mt-5">
                ...
                <Button label="돌아가기" className="light px-5 mx-2" onClick={() => history.push('/admin/beatbox_camp_documents')}/>
            </div>
        </div>
    )
};

export default BBApplicantDocument;