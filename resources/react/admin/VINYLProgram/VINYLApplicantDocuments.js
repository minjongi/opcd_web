...
const VINYLApplicantDocuments = () => {
    ...
    const handleGoToDetail = (item) => {
        if(item) history.push(`/admin/vinyl_camp_document/${item.id}`);
        else history.push(`/admin/vinyl_camp_document`)
    }
...
export default VINYLApplicantDocuments;