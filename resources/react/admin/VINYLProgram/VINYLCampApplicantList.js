...
const VINYLCampApplicantList = () => {
    ...
    const handleGoToDetail = (item) => {
        if(item) history.push(`/admin/vinyl_camp_applicant/${item.id}`);
        else history.push(`/admin/vinyl_camp_applicant`)
    }
    ...
    return (
        <div>
            ...
            <h4 className="mb-5">VINYL 신청자 목록</h4>
...
export default VINYLCampApplicantList;