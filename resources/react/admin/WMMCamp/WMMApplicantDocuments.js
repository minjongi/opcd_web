...
const columns = [
    {key: 'num', label: 'No.', sort: true, width: 70},
...
const WMMApplicantDocuments = () => {
    ...
    const handleGoToDetail = (item) => {
        if(item) history.push(`/admin/wmm_camp_document/${item.id}`);
        else history.push(`/admin/wmm_camp_document`)
    }
...
export default WMMApplicantDocuments;