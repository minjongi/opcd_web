...
import VIProgramEdit from './VIProgramEdit';
import VIProgramSubmit from './VIProgramSubmit';
import VIProgramView from './VIProgramView';
                ...
                <div className="songcamp-container">
                    ...
                    {campaigns && !!campaigns.length && 
                        <>
                            ...
                            {step === 1 && <VIProgramEdit campaign={campaigns[tab]} onSubmit={handleRequest}/>}
                            {step === 2 && <VIProgramSubmit tab={tab} userInfo={userState} campaign={campaigns[tab]} onSubmit={handleRequest}/>}
                            {step === 3 && <VIProgramView tab={tab} userInfo={userState} campaign={campaigns[tab]} onSubmit={handleRequest}/>}
                        </>
                    }
